...
public final class ProductDao_Impl implements ProductDao {
  ...
  public ProductDao_Impl(@NonNull final RoomDatabase __db) {
    ...
    this.__insertionAdapterOfProduct = new EntityInsertionAdapter<Product>(__db) {
      ...
      protected String createQuery() {
        return "INSERT OR ABORT INTO `products` (`id`,`name`,`code`,`imagePath`,`categoryId`,`costPrice`,`salePrice`,`stock`,`note`,`expiryDate`,`notifyDays`,`createdAt`,`updatedAt`) VALUES (nullif(?, 0),?,?,?,?,?,?,?,?,?,?,?,?)";
      }
      ...
      protected void bind(@NonNull final SupportSQLiteStatement statement, final Product entity) {
        ...
        if (entity.getExpiryDate() == null) {
          ...
          statement.bindLong(10, entity.getExpiryDate());
        }
        if (entity.getNotifyDays() == null) {
          statement.bindNull(11);
        } else {
          statement.bindLong(11, entity.getNotifyDays());
        }
    ...
    this.__updateAdapterOfProduct = new EntityDeletionOrUpdateAdapter<Product>(__db) {
      ...
      @NonNull
      protected String createQuery() {
        return "UPDATE OR ABORT `products` SET `id` = ?,`name` = ?,`code` = ?,`imagePath` = ?,`categoryId` = ?,`costPrice` = ?,`salePrice` = ?,`stock` = ?,`note` = ?,`expiryDate` = ?,`notifyDays` = ?,`createdAt` = ?,`updatedAt` = ? WHERE `id` = ?";
      }
  ...
  public Product getById(final int productId) {
    ...
    try {
      ...
      final int _cursorIndexOfNotifyDays = CursorUtil.getColumnIndexOrThrow(_cursor, "notifyDays");
      ...
      if (_cursor.moveToFirst()) {
        ...
        final Integer _tmpNotifyDays;
        if (_cursor.isNull(_cursorIndexOfNotifyDays)) {
          _tmpNotifyDays = null;
        } else {
          _tmpNotifyDays = _cursor.getInt(_cursorIndexOfNotifyDays);
        }
        final long _tmpCreatedAt;
        _tmpCreatedAt = _cursor.getLong(_cursorIndexOfCreatedAt);
        final long _tmpUpdatedAt;
        _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
        _result = new Product(_tmpName,_tmpCode,_tmpImagePath,_tmpCategoryId,_tmpCostPrice,_tmpSalePrice,_tmpStock,_tmpNote,_tmpExpiryDate,_tmpNotifyDays,_tmpCreatedAt,_tmpUpdatedAt);
        final int _tmpId;
  ...
  public List<Product> getAllSync() {
    ...
    try {
      ...
      while (_cursor.moveToNext()) {
        ...
        final long _tmpUpdatedAt;
        _tmpUpdatedAt = _cursor.getLong(_cursorIndexOfUpdatedAt);
        _item = new Product(_tmpName,_tmpCode,_tmpImagePath,_tmpCategoryId,_tmpCostPrice,_tmpSalePrice,_tmpStock,_tmpNote,_tmpExpiryDate,_tmpNotifyDays,_tmpCreatedAt,_tmpUpdatedAt);
        final int _tmpId;
        _tmpId = _cursor.getInt(_cursorIndexOfId);
        _item.setId(_tmpId);
        _result.add(_item);
