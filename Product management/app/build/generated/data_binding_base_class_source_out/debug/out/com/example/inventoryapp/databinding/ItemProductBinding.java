...
public final class ItemProductBinding implements ViewBinding {
  ...
  private ItemProductBinding(@NonNull MaterialCardView rootView,
      @NonNull MaterialCardView cardImage, @NonNull ImageView ivProduct,
      @NonNull TextView tvCategoryName, @NonNull TextView tvProductName,
      @NonNull TextView tvSalePrice, @NonNull TextView tvStock) {
  ...
  public static ItemProductBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ItemProductBinding((MaterialCardView) rootView, cardImage, ivProduct,
          tvCategoryName, tvProductName, tvSalePrice, tvStock);
    }
